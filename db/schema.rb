...
ActiveRecord::Schema[7.0].define(version: 2022_06_21_161414) do
  ...
  create_table "followers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["followed_by_user_id"], name: "index_followers_on_followed_by_user_id"
  ...
  add_foreign_key "followers", "users", column: "followed_by_user_id"
